...
import { ArrowRight, BookOpen, ChartColumn, CircleCheck, BadgeCheck, ClipboardList, Route, ShieldCheck, Target, TrendingUp } from "lucide-react";
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-9 grid max-w-2xl gap-3 sm:grid-cols-3">
              ...
              <div className="border-l border-white/15 pl-4">
                ...
                <p className="mt-1 text-sm leading-5 text-slate-300">readiness categories</p>
              </div>
              <div className="border-l border-white/15 pl-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <div className="mt-3 flex items-end gap-2">
                      <span className="text-6xl font-black tracking-tight">142</span>
